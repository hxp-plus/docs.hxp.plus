...
!!! warning "文档时效性说明"
    ...
    **已知过时点**：
    ...
    - containerd 1.7.11（1.7 系列 2026-09 EOL；k8s 1.36 起不再支持 1.7）
    - HAProxy 2.1.4（已 2021-06 EOL，存在未修复 CVE）
    - osixia/keepalived:2.0.17 上游项目 2021 年起停止维护
    - k8s 1.29.0（1.29 已 EOL，当前最新 1.36）
