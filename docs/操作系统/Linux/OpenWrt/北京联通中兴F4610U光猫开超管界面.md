...
!!! warning
    ...
    修改光猫配置可能导致网络中断或失去保修，请谨慎操作。

## 降级固件

从恩山论坛[北京联通光猫固件中兴 4610U_V1.2.0P1N20/N16 固件升降级及参数修改教程](https://www.right.com.cn/forum/thread-8361606-1-1.html)下载固件，使用普通账号和密码登录 <http://192.168.1.1>，在浏览器中复制粘贴这个地址：
