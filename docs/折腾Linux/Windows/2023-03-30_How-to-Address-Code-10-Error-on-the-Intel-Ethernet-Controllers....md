...
-   [摘要](https://www.intel.com/content/www/us/en/support/articles/000087288/ethernet-products.html#summary)
-   [问题描述](https://www.intel.com/content/www/us/en/support/articles/000087288/ethernet-products.html#description)
-   [解决方案](https://www.intel.com/content/www/us/en/support/articles/000087288/ethernet-products.html#resolution)
...
在设备管理器中查看时，Intel® Ethernet Controller 或 Intel® Ethernet Adapter 的状态显示为“Code 10，该设备无法启动”。
...
-   **继续**对系统进行断电重启：
    ...
    2.  **断开**计算机的电源线。
    3.  **按住**电源按钮约 30 秒。
    4.  **让**计算机保持断开状态约 10 分钟。
    5.  **重新连接**电源线，启动系统，并**检查** Intel® Ethernet Controller/Intel® Ethernet Adapter 的连接和状态。
    ...
    3.  **取出**电池。
    4.  **按住**电源按钮约 30 秒。
    5.  **让**笔记本电脑保持断开状态约 10 分钟。
    6.  **重新插入**电池以及充电器（如需要），并**检查** Intel® Ethernet Controller/Intel® Ethernet Adapter 的连接和状态。
-   **确认**已安装[最新的驱动程序](https://www.intel.com/content/www/us/en/download-center/home.html)。

<table><tbody><tr><td colspan="1" rowspan="1"><strong>注意</strong></td><td colspan="1" rowspan="1">如果这是品牌台式机或笔记本电脑，请优先使用制造商提供的最新驱动程序。</td></tr></tbody></table>
