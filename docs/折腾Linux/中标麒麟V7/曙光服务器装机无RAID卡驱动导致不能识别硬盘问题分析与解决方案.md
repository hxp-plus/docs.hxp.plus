...
以下是 modinfo megaraid_sas 在未挂载 DUD 镜像时的输出，可以看出 magaraid_sas 驱动的版本比较低，驱动厂商为 Avago：

![2a0527997c7166e7e9abe9b312dfe612.png](./images/a6fbfdb2491a46628c5594452f35b85e.png)

以下是已装好系统的服务器上 megaraid_sas 驱动的信息，驱动版本高，而且厂商为 Boardcom（Avago 收购 Boardcom 后改了公司的名字为 Boardcom，因此 Boradcom 和 Avago 是一个公司）：
